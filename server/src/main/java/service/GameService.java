...
public class GameService {
    ...
    public GameData createGame(String gameName, String authToken) throws DataAccessException {
        ...
        if(gameName == null) {
            throw new DataAccessException("Error: Game name is missing");
        }
    ...
    public void joinGame(int gameID, String playerColor, String authToken) throws DataAccessException {
        ...
        if(playerColor.equalsIgnoreCase("WHITE")) {
            if(whitePlayer != null) {
                throw new DataAccessException("Error: white user is already taken");
            }
            whitePlayer = username;
        }else if(playerColor.equalsIgnoreCase("BLACK")) {
            if(blackPlayer != null) {
                throw new DataAccessException("Error: black user is already taken");
            }
